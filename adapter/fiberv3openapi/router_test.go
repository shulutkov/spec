...
func TestRouter_Spec(t *testing.T) {
	tests := []struct {
		...
		setup     func(r fiberv3openapi.Router)
		shouldErr bool
	}{
		{
			name:   "Pet Store API",
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			r := fiberv3openapi.NewRouter(app, opts...)
...
type SingleRouteFunc func(string, ...fiber.Handler) fiberv3openapi.Route

func TestRouter_Single(t *testing.T) {
	tests := []struct {
		method     string
		path       string
		methodFunc func(r fiberv3openapi.Router) SingleRouteFunc
	}{
		{"GET", "/ping", func(r fiberv3openapi.Router) SingleRouteFunc { return r.Get }},
		{"HEAD", "/ping", func(r fiberv3openapi.Router) SingleRouteFunc { return r.Head }},
		{"POST", "/ping", func(r fiberv3openapi.Router) SingleRouteFunc { return r.Post }},
		{"PUT", "/ping", func(r fiberv3openapi.Router) SingleRouteFunc { return r.Put }},
		{"PATCH", "/ping", func(r fiberv3openapi.Router) SingleRouteFunc { return r.Patch }},
		{"DELETE", "/ping", func(r fiberv3openapi.Router) SingleRouteFunc { return r.Delete }},
		{"CONNECT", "/ping", func(r fiberv3openapi.Router) SingleRouteFunc { return r.Connect }},
		{"OPTIONS", "/ping", func(r fiberv3openapi.Router) SingleRouteFunc { return r.Options }},
		{"TRACE", "/ping", func(r fiberv3openapi.Router) SingleRouteFunc { return r.Trace }},
	}
	for _, tt := range tests {
...
func TestRouter_Group(t *testing.T) {
	...
	t.Run("Route", func(t *testing.T) {
		...
		r.Route("/api", func(r fiberv3openapi.Router) {
...
func TestGenerator_Docs(t *testing.T) {
	...
	t.Run("should serve docs", func(t *testing.T) {
		...
		assert.Contains(
			...
			string(body),
			"Fiber v3 OpenAPI",
			"expected response body to contain 'Fiber v3 OpenAPI' for docs route",
		)
	})
...
func TestGenerator_Assets(t *testing.T) {
	app := fiber.New()
	r := fiberv3openapi.NewRouter(app, option.WithUIOption(stoplightemb.WithUI()))
	r.Get("/ping", PingHandler).With(
...
func TestGenerator_DisableDocs(t *testing.T) {
	...
	app := fiber.New()
	r := fiberv3openapi.NewRouter(app, option.WithDisableDocs())
	r.Get("/ping", pingHandler).With(
		option.Summary("Ping Endpoint"),
	...
	t.Run("should not register openapi.yaml route", func(t *testing.T) {
		...
		resOpenAPI, err := app.Test(reqOpenAPI)
		require.NoError(t, err, "failed to test OpenAPI YAML route")
...
func TestGenerator_WriteSchemaTo(t *testing.T) {
	app := fiber.New()
	r := fiberv3openapi.NewGenerator(app,
